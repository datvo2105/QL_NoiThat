...
public class MainFrame extends javax.swing.JFrame {
    ...
    // <editor-fold defaultstate="collapsed" desc="Generated
        ...
        private void initComponents() {
                ...
                btn_UserKey = new javax.swing.JButton();
                ...
                listUser.setModel(new javax.swing.table.DefaultTableModel(
                        ...
                        new String [] {
                                "Mã Người Dùng", "Tài Khoản", "Mật Khẩu", "Họ", "Tên", "Email", "Quyền"
                        }
                ) {
                        boolean[] canEdit = new boolean [] {
                ...
                jLabel27.setText("Mã Người Dùng");
                ...
                cb_UserRole.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "User", "Admin" }));

                btn_editUser.setText("Sửa");
                ...
                btn_UserKey.setText("Tạo Khóa");
                btn_UserKey.addActionListener(new java.awt.event.ActionListener() {
                        public void actionPerformed(java.awt.event.ActionEvent evt) {
                                btn_UserKeyActionPerformed(evt);
                        }
                });
        ...
        private void btn_UserKeyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_UserKeyActionPerformed
                // TODO add your handling code here:
        }//GEN-LAST:event_btn_UserKeyActionPerformed
    ...
    private void listUserMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_listUserMouseClicked
        ...
        if (selectedRow >= 0) {
            userSelected = mapToUser(selectedRow);
            txt_UserId.setText(String.valueOf(userSelected.getUserId()));
            txt_Username.setText(userSelected.getUserName());
            txt_Password.setText(userSelected.getPassword());
            txt_UserFirstname.setText(userSelected.getFirstName());
            txt_UserLastname.setText(userSelected.getLastName());
            txt_UserEmail.setText(userSelected.getEmail());
            cb_UserRole.setSelectedItem(userSelected.getRole());
    ...
    private void btn_addUserActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btn_addUserActionPerformed
        User user = new User(
                ...
                txt_UserFirstname.getText(),
                txt_UserLastname.getText(),
                txt_UserEmail.getText(),
                (String) cb_UserRole.getSelectedItem());

        boolean isAdded = userDb.createUser(user);
    ...
    private User mapToUser(int selectedRow) {
        User user = new User();
        user.setUserId((int) listUser.getValueAt(selectedRow, 0));
        user.setUserName((String) listUser.getValueAt(selectedRow, 1));
        user.setPassword((String) listUser.getValueAt(selectedRow, 2));
        user.setFirstName((String) listUser.getValueAt(selectedRow, 3));
        user.setLastName((String) listUser.getValueAt(selectedRow, 4));
        user.setEmail((String) listUser.getValueAt(selectedRow, 5));
        user.setRole((String) listUser.getValueAt(selectedRow, 6));
    ...
    private void btn_deleteProductActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btn_deleteProductActionPerformed
        ...
        private javax.swing.JButton btn_UserKey;
